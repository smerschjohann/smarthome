 ...
 * @author Simon Merschjohann - modified to use runnable
 *
 */
public class TimerExecutionJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        Runnable procedure = (Runnable) context.getJobDetail().getJobDataMap().get("procedure");
        Timer timer = (Timer) context.getJobDetail().getJobDataMap().get("timer");
        procedure.run();
