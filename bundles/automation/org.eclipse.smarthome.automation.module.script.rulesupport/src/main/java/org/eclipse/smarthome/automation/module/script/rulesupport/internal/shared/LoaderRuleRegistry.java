...
/**
 * The LoaderRuleRegistry is wrapping a RuleRegistry to provide a comfortable way to add rules to the RuleEngine without
 * worrying about the need to remove rules again. Nonetheless, using the addPermanent method it is still possible to add
 * rules permanently.
 *
